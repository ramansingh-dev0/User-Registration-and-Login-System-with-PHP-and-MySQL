...
<div class="sound">
    ...
    <div class="containers">
       ...
       <form  action="registration.php" method="POST" >
            <div class="login-field">
                ...
                <input type="text" placeholder="name" id="user" name="fullname">
            </div>
            <div class="login-field">
                <label for="email">
            ...
            <div class="login-field">   
                ...
                </label> <input type="password" placeholder="create password" id="password" name="password">
            </div>
            <div class="login-field">   
                <label for="cpassword">
                ...
                </label> <input type="password" placeholder="confirm password" id="cpassword" name="repeat_password">
            </div>
            <button type="submit" id="btn" value="Login" name="submit">Sign Up</button>
    ...
    <script src="
https://cdn.jsdelivr.net/npm/lucide@0.433.0/dist/cjs/lucide.min.js
"></script>
</body>
</html>